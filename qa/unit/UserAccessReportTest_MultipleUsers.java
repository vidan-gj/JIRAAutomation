...
public class UserAccessReportTest_MultipleUsers {
  ...
  Test is configured to run on Stage and Prod.
	...
	public void testUserAccessReport() throws Exception {
		...
		String user = ExcelUtility.getCellData(19, 6);	// uses same user from previous test
     ...
     ---------------   LOGIC FOR MULTIPLE ELEMENT SELECTION (select 1 element + hold key (shift) + select 2nd element)   ------------------
		...
		Action holdShiftAndSelect = selectActions.keyDown(Keys.SHIFT).moveToElement(secondElement).click().build();
		...
		// ---------------------------------------------------------------------------------------------------------------------------------------	
		// Enter User Info
		driver.findElement(By.name("lanIDList")).clear();
/*		driver.findElement(By.name("lanIDList")).sendKeys("vgjoze01 ");
		driver.findElement(By.name("lanIDList")).sendKeys(",");*/
		driver.findElement(By.name("lanIDList")).sendKeys("kmahal01 ");
		driver.findElement(By.name("lanIDList")).sendKeys(",");
		driver.findElement(By.name("lanIDList")).sendKeys("pganes02");
		...
		assertEquals("pganes02", driver.findElement(By.xpath("//section[@id='content']/div/div/section/div/font/table/tbody/tr[5]/td[2]")).getText());
		//assertEquals("vgjoze01", driver.findElement(By.xpath("//section[@id='content']/div/div/section/div/font/table/tbody/tr[7]/td[2]")).getText());
		Thread.sleep(3000);
		...
		assertEquals("SCRM", driver.findElement(By.xpath("//section[@id='content']/div/div/section/div/font/table/tbody/tr[5]/td[3]")).getText());
		//assertEquals("SCRM", driver.findElement(By.xpath("//section[@id='content']/div/div/section/div/font/table/tbody/tr[7]/td[3]")).getText());
		Thread.sleep(3000);
		...
		assertEquals("SCRM", driver.findElement(By.xpath("//section[@id='content']/div/div/section/div/font/table/tbody/tr[5]/td[5]")).getText());
		//assertEquals("SCRM", driver.findElement(By.xpath("//section[@id='content']/div/div/section/div/font/table/tbody/tr[7]/td[5]")).getText());
		Thread.sleep(3000);
